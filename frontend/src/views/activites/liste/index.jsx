...
const ActiviteListCreate = () => {
  ...
  return (
    <div>
      ...
      <div>
        <TextField name="nom" label="Nom de l'activité" value={newActivite.nom} onChange={handleInputChange} />
        <TextField name="description" label="Description de l'activité" value={newActivite.description} onChange={handleInputChange} />
