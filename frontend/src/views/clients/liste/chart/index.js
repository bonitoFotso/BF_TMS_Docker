    ...
    <Container maxWidth="lg">
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={4}>
          <Paper elevation={3} sx={{ p: 2, height: '100%' }}>
            <Typography variant="h6" mb={2}>
              Répartition des clients sous contrat
            </Typography>
            <ContractChart contractedClients={data.contracted_clients} nonContractedClients={data.non_contracted_clients} />
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={4}>
          <Paper elevation={3} sx={{ p: 2, height: '100%' }}>
            <Typography variant="h6" mb={2}>
              Répartition des agences par client
            </Typography>
        ...
        <Grid item xs={12}>
          <Paper elevation={3} sx={{ p: 2 }}>
            <Typography variant="h6" mb={2}>
              Évolution du nombre de clients au fil du temps
            </Typography>
